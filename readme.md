...
> `Virtual Machines` run inside a PHYSICAL computer  that runs an operating system and applications just like a physical computer. VM Runs on top of a hypervisor like `VMware`. Basically A Virtual Machine emulates a full computer system on top of another system. 
